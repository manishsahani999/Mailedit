    ...
    <div class="wrap">
        ...
        <div class="home-body">
                ...
                <div class="col m-l-2" id="register-right">
                    ...
                    <div class="register_wrap m-t-2">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <textarea name="description" class="form-control form-control-lg" cols="30" rows="7">
                                {{ old('description') }}
                            </textarea>
                        </div>
                    </div>
            ...
            <div class="form-group text-center mt-5">
                <button type="submit" class="btn bt btn-template">Create This Template</button>
            </div>
            </form>
            <!-- form end -->
        </div>
